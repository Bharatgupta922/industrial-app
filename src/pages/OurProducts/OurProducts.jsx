				...
				<div className="container">
					<div className="row">
						<div className="col-sm">
							<Link
								...
								to={{ pathname: "/explaination", index: "1" }}
							>
						...
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "2" }}
							>
								<div className="package">
					...
					<div className="row">
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "3" }}
							>
								<div className="package">
						...
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "4" }}
							>
								<div className="package">
					...
					<div className="row">
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "5" }}
							>
								<div className="package">
						...
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "6" }}
							>
								<div className="package">
					...
					<div className="row">
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "7" }}
							>
								<div className="package">
						...
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "8" }}
							>
								<div className="package">
					...
					<div className="row">
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "9" }}
							>
								<div className="package">
						...
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "10" }}
							>
								<div className="package">
					...
					<div className="row">
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "11" }}
							>
								<div className="package">
						...
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "12" }}
							>
								<div className="package">
					...
					<div className="row">
						<div className="col-sm">
							<Link
								style={{ textDecoration: "none" }}
								to={{ pathname: "/explaination", index: "13" }}
							>
								<div className="package">
