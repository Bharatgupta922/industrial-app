    ...
    return (
        <div className="ourproducts">
                    ...
                    <div className="row">
                        <div className="col-sm">
                            <div className="container points">
                                <div className="row"> ● Treatment concept for waste water with the help of ANAEROBIC followed by AEROBIC Biological Treatment </div>
                                <div className="row"> ● Speciality chemicals used in the process.</div>
            ...
            <div className="container">
                <div className="row">
                <div>
                       <div className="Technical__services__logos"> <img src={icon1} alt="icon1" /></div>
                        <p>Shop floor investigation for any kind of problems in the process house</p>
                    </div>
                </div>
                <div className="row">
                <div>
                <div className="Technical__services__logos"><img src={icon2} alt="icon2" /></div>
                        <p>Problem of inconsistent fabric quality and conservation of water in a wet processing unit </p>
                    </div>
                </div>
                <div className="row">
                <div>
                <div className="Technical__services__logos"><img src={icon3} alt="icon3" /></div>
                        <p>Cost saving studies in a modern process house</p>
                    </div>
                </div>
                <div className="row">
                <div>
                <div className="Technical__services__logos"><img src={icon4} alt="icon4" /></div>
                        <p>Machinery maintenance audit in a modern process house to improve fabric quality </p>
                    </div>
                </div>
                <div className="row">
                <div>
                <div className="Technical__services__logos"><img src={icon5} alt="icon5" /></div>
                        <p>Maintenance practices and stores consumption based on present processing machinery </p>
                    </div>
                </div>
                <div className="row">
                <div>
                <div className="Technical__services__logos"><img src={icon6} alt="icon6" /></div>
                        <p>Technical training for operators </p>
                    </div>
                </div>
                <div className="row">
                <div>
                <div className="Technical__services__logos"><img src={icon7} alt="icon7" /></div>
                        <p>SOP preparation</p>
                    </div>
                </div>
                <div className="row">
                <div>
                <div className="Technical__services__logos"><img src={icon8} alt="icon8" /></div>
                        <p>Online Process control and water conservation audit in a process house </p>
                    </div>
                </div>
                <div className="row">
                <div>
                <div className="Technical__services__logos"><img src={icon9} alt="icon9" /></div>
