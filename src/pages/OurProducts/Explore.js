...
const Explore = () => {
	const data = {
		heading_1: {
			...
			para_2:
				"On the basis of requirement of oxygen bacteria is classified as AEROBIC BACTERIA and ANAEROBIC BACTERIA. Aerobic bacteria necessarily require oxygen for their life process however, the anaerobic bacteria can survive without oxygen.",
			para_3:
				" Accordingly on the basis of types of bacteria used in ETP the basic treatment process are classified as AEROBIC TREATMENT and ANAEROBIC TREATMENT.",
		},
		heading_2: {
			title: "THE ANAEROBIC PROCESS",
			para_1:
				"The Anaerobic process is basically the natural phenomenon of fermentation in which organic materials are degraded by micro-organism without consuming oxygen. This results the production of carbon dioxide and methane. ",
			para_2:
		...
		heading_6: {
			...
			para_2:
				"Anaerobic microbial cultures are easy to use and do not require any pre-treatment and can be used directly as and when required, even in unsealed condition. ",
			para_3:
				"These microbial culture are effectively used in anaerobic industrial effluent treatment and systems (anaerobic digester & n fill tower for Chemical, Pharmaceutical & Many other industries where the effluent is difficult to treat. The culture consists of a blend of micro organisms which are non-pathogenic, saprophytic and fast growing. They act by converting the complex long chain organic compounds to simple sugars, which are further converted into Methane & water. If used in combination with Enzymes, (marketed by New Era Global Pvt. Ltd.) they are still more effective. ",
		},
		heading_7: {
		...
		heading_9: {
			...
			para_2:
				"All Products are manufactured under strict process control & as per standard practices .If gas formation observed, pin a hole to inner cap of Container & release the gas. ",
		},
	};
							...
							<div class="card-body">
								<div className="container">
									<div className="row">
										...
										<div className="col-sm">
											<p className="card-text first__para">
												{" "}
												{data.heading_1.para_1}{" "}
											</p>
										</div>
									</div>
									<p className="card-text card__content">
										{" "}
										{data.heading_1.para_2}{" "}
									</p>
									<p className="card-text card__content">
										{" "}
										{data.heading_1.para_3}{" "}
									</p>
									<p className="card-title card__heading">
										{" "}
										{data.heading_2.title}{" "}
									</p>
									<p className="card-text card__content">
										{" "}
										{data.heading_2.para_1}{" "}
									</p>
									<p className="card-text card__content">
										{" "}
										{data.heading_2.para_2}{" "}
									</p>
									<p className="card-text card__content">
										{" "}
										{data.heading_2.para_3}{" "}
									</p>
									<p className="card-title card__heading">
										{" "}
										{data.heading_3.title}{" "}
									</p>
									<p className="card-text card__content">
										1. {data.heading_3.para_1}{" "}
									</p>
									<p className="card-text card__content">
										2. {data.heading_3.para_2}{" "}
									</p>
									<p className="card-text card__content">
										3. {data.heading_3.para_3}{" "}
									</p>
									<p className="card-text card__content">
										4. {data.heading_3.para_4}{" "}
									</p>
									<p className="card-text card__content">
										5. {data.heading_3.para_5}{" "}
									</p>

									<p className="card-title card__heading">
										{" "}
										{data.heading_4.title}{" "}
									</p>
									<p className="card-text card__content">
										1. {data.heading_4.para_1}{" "}
									</p>
									<p className="card-text card__content">
										2. {data.heading_4.para_2}{" "}
									</p>
									<p className="card-text card__content">
										3. {data.heading_4.para_3}{" "}
									</p>
									<p className="card-text card__content">
										4. {data.heading_4.para_4}{" "}
									</p>
									<p className="card-text card__content">
										5. {data.heading_4.para_5}{" "}
									</p>
									<p className="card-text card__content">
										6. {data.heading_4.para_6}{" "}
									</p>
									<p className="card-text card__content">
										7. {data.heading_4.para_7}{" "}
									</p>
									<p className="card-title card__heading">
										{" "}
										{data.heading_5.title}{" "}
									</p>
									<p className="card-text card__content">
										{" "}
										{data.heading_5.para_1}{" "}
									</p>
									<p className="card-title card__heading">
										{" "}
										{data.heading_6.title}{" "}
									</p>
									<p className="card-text card__content">
										{" "}
										{data.heading_6.para_1}{" "}
									</p>
									<p className="card-text card__content">
										{" "}
										{data.heading_6.para_2}{" "}
									</p>
									<p className="card-text card__content">
										{" "}
										{data.heading_6.para_3}{" "}
									</p>
								</div>
								<div className="container">
									<div className="row">
										<div className="col-sm">
											<p className="card-title card__heading">
												{" "}
												{data.heading_7.title}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_7.para_1.title} :{" "}
												{data.heading_7.para_1.description}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_7.para_2.title} :{" "}
												{data.heading_7.para_2.description}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_7.para_3.title} :{" "}
												{data.heading_7.para_3.description}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_7.para_4.title} :{" "}
												{data.heading_7.para_4.description}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_7.para_5.title} :{" "}
												{data.heading_7.para_5.description}{" "}
											</p>
										</div>
										<div className="col-sm">
											<p className="card-title card__heading">
												{" "}
												{data.heading_8.title}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_8.para_1}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_8.para_2}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_8.para_3}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_8.para_4}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_8.para_5}{" "}
											</p>
											<p className="card-text card__content">
												{" "}
												● {data.heading_8.para_6}{" "}
											</p>
										</div>
									</div>
								</div>
								<p className="card-title card__heading">
									{" "}
									{data.heading_9.title}{" "}
								</p>
								<p className="card-text card__content">
									{" "}
									{data.heading_9.para_1}{" "}
								</p>
								<p className="card-text card__content">
									{" "}
									{data.heading_9.para_2}{" "}
								</p>
							</div>
						</div>
					</div>
